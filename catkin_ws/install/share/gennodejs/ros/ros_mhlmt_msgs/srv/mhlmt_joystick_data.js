...
class mhlmt_joystick_dataRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mhlmt_joystick_dataRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mhlmt_joystick_dataRequest
    let len;
    let data = new mhlmt_joystick_dataRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mhlmt_joystick_dataRequest(null);
...
class mhlmt_joystick_dataResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mhlmt_joystick_dataResponse
    // Serialize message field [state]
    bufferOffset = _serializer.bool(obj.state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mhlmt_joystick_dataResponse
    let len;
    let data = new mhlmt_joystick_dataResponse(null);
    // Deserialize message field [state]
    data.state = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mhlmt_joystick_dataResponse(null);
    if (msg.state !== undefined) {
      resolved.state = msg.state;
    }
    else {
...
module.exports = {
  Request: mhlmt_joystick_dataRequest,
  Response: mhlmt_joystick_dataResponse,
  md5sum() { return '1329a64fad65e08bad5df97dce71b9e1'; },
  datatype() { return 'ros_mhlmt_msgs/mhlmt_joystick_data'; }
};
